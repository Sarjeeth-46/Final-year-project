...
class IncidentLifecycleManager:
    ...
    @classmethod
    def retrieve_incident_feed(cls, limit: int = 100, lifecycle_state: Optional[str] = None) -> List[Dict]:
        """
        Fetches the operational event feed with optional state filtering.
        """
